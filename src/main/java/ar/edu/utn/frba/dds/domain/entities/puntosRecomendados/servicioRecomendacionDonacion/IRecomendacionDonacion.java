...
public interface IRecomendacionDonacion {
    ...
    Call<RecomendacionPersonasVulnerables> recomendacionPersonasVulnerables(@Query("radio_max") float radio_max, @Query("calle") String calle, @Query("altura") String altura, @Query("provincia") String provincia);
